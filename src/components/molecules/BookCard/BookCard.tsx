        ...
        <CardContent className={classes.content}>
          ...
          <Table className={classes.table}>
            <TableRow>
              ...
              <TableCell className={classes.cell}><Typography className={classes.author} variant="overline">Author</Typography></TableCell>
            </TableRow>
            <TableRow>
              <TableCell className={classes.cell}><Typography className={classes.authorName} variant="subtitle2">{authorName}</Typography></TableCell>
            </TableRow>
          </Table>
          <CardActions>
