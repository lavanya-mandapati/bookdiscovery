...
import { Box, CardActions, CardMedia, Grid, makeStyles, TableCell, TableRow, Typography } from "@material-ui/core";
...
const BookDetail: React.FC<BookDetailProps> = (props) => {
    const descArray=props.desc.split(". By using");
    descArray[0]=descArray[0]+".";
    descArray[1]="By using"+descArray[1].slice(0,descArray.length-35);
    ...
    return (
        <React.Fragment>
                ...
                <div>
                    <div className={classes.flex}>
                        ...
                        <TableCell align="left" className={classes.border}>
                            <TableRow>
                                <div className="round" ></div></TableRow>
                            <TableRow><Typography variant="overline" className={classes.pages}>0 read / 285 pages</Typography></TableRow></TableCell>
                    </div>
                    <CardActions className={classes.firstActions}>
                        <Typography variant="body2" className={classes.by}>by</Typography>
                        <Typography className={classes.authorName} variant="h6">{props.authorName}</Typography>
                    </CardActions>
                    <CardActions className={classes.actions}>
                        <Typography variant="body2" className={classes.field}>Field:</Typography>
                        <Typography className={classes.fieldName} variant="subtitle2">{props.fieldName}</Typography>
                    </CardActions>
                    <CardActions className={classes.actions}>
                        ...
                        <Typography className={classes.rating} variant="body2">( 1,204 reviews )</Typography>
                    </CardActions>
                    <CardActions className={classes.actions}>
                        <NewReleasesOutlinedIcon className={classes.release} />
                        <Typography variant="body2" className={classes.releaseDate}>Release Date: {props.releaseDate}</Typography>
                        <LanguageIcon className={classes.languageIcon} />
                        <Typography variant="body2" className={classes.language}>{props.language}</Typography>
                    </CardActions>
                    <CardActions className={classes.actions}>
            ...
            <Typography variant="h4" className={classes.desc}>Book Description</Typography>
            <Typography variant="h6" className={classes.descText}>{descArray[0]}</Typography>
            <Typography variant="h6" className={classes.descText}>{descArray[1]}</Typography>
            <CardActions className={classes.spacing}>
            <Typography variant="h6" className={classes.descTextEnd}>networks. With exercises in each</Typography>
