...
const useStyles = makeStyles({
  ...
  icon: {
    color: COLORS.PRIMARY_COLOR_500,
    margin: theme.spacing(6.6, 0, 1, 0),
    fontSize: "12px"
  },
  div2: {
    display: "flex",
  ...
  return (
    <Grid className={classes.root}>
      ...
      <Grid className={classes.div2}>
        <Typography variant="h3" className={classes.heading}>Books By Joe Pearson</Typography>
        <Typography variant="body2" className={classes.text1}>See more</Typography>
            ...
            <Card className={classes.card} key={index} variant="outlined">
              <CardContent>
                <Grid container spacing={2}>
                  <Grid item>
                    <Avatar src={book.image} className={classes.avatar} variant="square" />
                  </Grid>
                  <Grid item xs={6} className={classes.innerGrid}>
                    <Grid>
                      <Typography className={classes.title} children={CONSTANTS.BOOKTITLE} />
                    </Grid>
