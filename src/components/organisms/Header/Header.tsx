...
import CustomButtonVal from '../Explore/Explore';
    ...
    return (
        <div className={classes.root}>
            <div className={classes.part1}>
                ...
                <CustomButtonVal name="Explore" />
                <CustomButtonVal name="My Library" />
            </div>
